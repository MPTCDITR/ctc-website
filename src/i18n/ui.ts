...
export const ui: Record<string, Record<string, string>> = {
  ...
  km: {
    ...
    'about.vision.description': '	ចក្ខុវិស័យរបស់ ម.ប.ស. គឺលើកកម្ពស់ការចូលរួមកសាងសេដ្ឋកិច្ច និងសង្គមឌីជីថលរបស់ប្រជាពលរដ្ឋក្នុងសហគមន៍ តាមរយៈការបណ្តុះបណ្តាលជំនាញបច្ចេកវិទ្យាឌីជីថលសម្រាប់ប្រើប្រាស់ក្នុងជីវភាពរស់នៅប្រចាំថ្ងៃប្រកបដោយប្រសិទ្ធភាព និងការទទួលខុសត្រូវខ្ពស់។',
    ...
    'about.structure.description2': 'ក្រុមប្រឹក្សាជាតិ  ម.ប.ស. ត្រួតពិនិត្យ ម.ប.ស. ទាំងអស់  និងទទួលខុសត្រូវលើការអនុវត្តយុទ្ធសាស្ត្រ ធានាតម្លាភាព គ្រប់គ្រងធនធាន ការអភិវឌ្ឍន៍ និងសហការជាមួយភាគីពាក់ព័ន្ធ ដើម្បីលើកកម្ពស់ភាពជាដៃគូ ពិនិត្យ និងអនុម័តផែនការការងារ និងថវិកា និងតាមដានការអនុវត្ត។ ក្រុមប្រឹក្សាភិបាលក៏រៀបចំរបាយការណ៍វឌ្ឍនភាពសម្រាប់រាជរដ្ឋាភិបាលកម្ពុជា និងបំពេញភារកិច្ចសំខាន់ៗផងដែរ។',
    'about.structure.ctcnational.board': 'ក្រុមប្រឹក្សាជាតិ ម.ប.ស.',
    'about.structure.ctcnational.board.description': 'ក្រុមប្រឹក្សាជាតិ ម.ប.ស. ដឹកនាំដោយរដ្ឋមន្ត្រីក្រសួងប្រៃសណីយ៍ និងទូរគមនាគមន៍ និងមានតំណាងមកពីក្រសួងអប់រំ កីឡា និងយុវជន ក្រសួងប្រៃសណីយ៍ និងទូរគមនាគមន៍ និងប្រធានលេខាធិការដ្ឋាន។',
