...
export const ui: Record<string, Record<string, string>> = {
  en: {
    ...
    'home.center.description': 'The Ministry of Posts and Telecommunications, in collaboration with the Ministry of Education, Youth and Sports, plans to build and establish Community Technology Centers (C.T.C.) in 558 public high school campuses nationwide, of which 18 have now been established.',
    ...
    'about.structure.description2': 'The C.T.C. National Board is responsible for directing the implementation and oversight of strategies, action plans, and operations of all C.T.C.',
    'about.structure.ctcnational.board': 'C.T.C National Board',
    'about.structure.ctcnational.board.description': 'The National Board of the C.T.C. oversees the implementation of the strategy, ensures transparency, manages resources for the C.T.C. development and collaborates with stakeholders to promote partnerships, reviews and approves the work plan and budget, and monitors implementation. The Board also prepares progress reports for the government and performs other important tasks.',
    ...
    'our.ctc.description':'The official and first launch of the C.T.C, starting with public high schools in Takeo Province, is planned to expand the scope of C.T.C operations to public high schools in other provinces of the Kingdom of Cambodia.',
    'our.ctc.allinfo.title':'Search for Centers Information',
    'our.ctc.allinfo.description':'Overview of our tech centers across Cambodia, including learning program, operation details, and center-specific information.',
    'ctc.management.title':'Community Tech Center Management and Operation',
    'ctc.management.description':' Overview information of our technology centers, with providing detailed insights into the management structures, the roles and responsibilities of operational staff, as well as specific contact information of operational member, and community information.',
  ...
  km: {
    ...
    'home.service.postoffice.description': 'សម្រាប់ផ្តល់សេវាទទួល និងផ្ញើកញ្ចប់អីវ៉ាន់ក្នុង និងក្រៅប្រទេស ព្រមទាំងផ្តល់សេវាផ្សេងៗដល់ពាណិជ្ជករ អាជីវករ និងប្រជាពលរដ្ឋនៅសហគមន៍។',
    'home.service.publichall': 'សាលសាធារណៈ',
    'home.service.publichall.description': 'សម្រាប់ប្រជាពលរដ្ឋនៅសហគមន៍អាចចូលប្រើប្រាស់កុំព្យូទ័រ និងអ៊ីនធឺណិត ដើម្បីស្វែងរកព័ត៌មានពាក់ព័ន្ធនឹងកសិកម្ម អាជីវកម្ម និងសេវាសាធារណៈអនឡាញ។',
    'home.center.description': 'ក្រសួងប្រៃសណីយ៍ និងទូរគមនាគមន៍ សហការជាមួយក្រសួងអប់រំ យុវជន និងកីឡា មានគម្រោងសាងសង់ និងបង្កើតមជ្ឈមណ្ឌលបច្ចេកវិទ្យាសហគមន៍ (ម.ប.ស.) ក្នុងបរិវេណវិទ្យាល័យសាធារណៈនៅទូទាំងប្រទេស ចំនួន ៥៥៨កន្លែង ដែលបច្ចុប្បន្នបានបង្កើតបាន ចំនួន ១៨កន្លែង។',
    ...
    'about.structure.description2': 'ក្រុមប្រឹក្សាជាតិ ម.ប.ស. មានតួនាទីដឹកនាំការអនុវត្ត និងត្រួតពិនិត្យយុទ្ធសាស្ត្រ ផែនការសកម្មភាព និងប្រតិបត្តិការរបស់ ម.ប.ស.។',
    'about.structure.ctcnational.board': 'ក្រុមប្រឹក្សាជាតិ ម.ប.ស.',
    'about.structure.ctcnational.board.description': 'ក្រុមប្រឹក្សាជាតិ ម.ប.ស. ត្រួតពិនិត្យការអនុវត្តយុទ្ធសាស្ត្រ ធានាតម្លាភាព គ្រប់គ្រងធនធានសម្រាប់ ម.ប.ស. ការអភិវឌ្ឍន៍ និងសហការជាមួយភាគីពាក់ព័ន្ធ ដើម្បីលើកកម្ពស់ភាពជាដៃគូ ពិនិត្យ និងអនុម័តផែនការការងារ និងថវិកា និងតាមដានការអនុវត្ត។ ក្រុមប្រឹក្សាភិបាលក៏រៀបចំរបាយការណ៍វឌ្ឍនភាពសម្រាប់រដ្ឋាភិបាល និងបំពេញភារកិច្ចសំខាន់ៗផងដែរ។',
    ...
    'our.ctc.description':'ការចាប់ផ្តើមដាក់ឱ្យដំណើរការ ម.ប.ស. ជាផ្លូវការ និងដំបូងគេបង្អស់ ដែលចាប់ផ្តើមពីវិទ្យាល័យ សាធារណៈក្នុងខេត្តតាកែវ ក.ប.ទ. គ្រោងនឹងពង្រីកវិសាលភាពប្រតិបត្តិការ ម.ប.ស. នៅវិទ្យាល័យសាធារណៈក្នុងខេត្ត ដទៃទៀតនៃព្រះរាជាណាចក្រកម្ពុជា',
    'our.ctc.allinfo.title':'ស្វែងរកព័ត៌មានអំពីមជ្ឈមណ្ឌល',
    'our.ctc.allinfo.description':'កិច្ចសង្ខេបអំពីមជ្ឈមណ្ឌលបច្ចេកវិទ្យារបស់យើងនៅទូទាំងប្រទេសកម្ពុជា រួមទាំងកម្មវិធីសិក្សា ព័ត៌មានលម្អិតអំពីប្រតិបត្តិការ និងព័ត៌មានជាក់លាក់នៃមជ្ឈមណ្ឌល។',
    'ctc.management.title':'ការគ្រប់គ្រង និងប្រតិបត្តិការមជ្ឈមណ្ឌលបច្ចេកវិទ្យាសហគមន៍',
    'ctc.management.description':'ស្វែងយល់អំពីព័ត៌មានទូទៅនៃមជ្ឈមណ្ឌលបច្ចេកវិទ្យារបស់យើង ជាមួយនឹងការផ្តល់នូវការយល់ដឹងលម្អិតអំពីរចនាសម្ព័ន្ធគ្រប់គ្រង តួនាទី និងការទទួលខុសត្រូវរបស់បុគ្គលិកប្រតិបត្តិការ ក៏ដូចជាព័ត៌មានទំនាក់ទំនងជាក់លាក់របស់សមាជិកប្រតិបត្តិ និងព័ត៌មានសហគមន៍។',
    ...
    'blog.list.description':'សូមស្វែងរកព័ត៌មានអាប់ដេតអំពីព្រឹត្តិការណ៍ថ្មីៗ ការប្រមូលផ្តុំ និងសកម្មភាពនៅក្នុងមជ្ឈមណ្ឌល និងការបង្ហាញពីវគ្គសិក្សាដែលនឹងមកដល់ សម័យបណ្តុះបណ្តាល ការប្រជុំសហគមន៍ និងព្រឹត្តិការណ៍ដែលពាក់ព័ន្ធនឹងបច្ចេកវិទ្យា ដែលមានគោលបំណងដើម្បីលើកកម្ពស់ការចូលរួម និងការរៀននៅក្នុងចំណោមសមាជិកសហគមន៍។'
}
} as const;
