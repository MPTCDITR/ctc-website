        ...
        <div class="p-4 rounded-lg">
            ...
            <ul class="list-disc list-inside">
                <li class="flex items-center gap-x-3">
                    ...
                    <a href="https://maps.app.goo.gl/crsZwq9awQAihqbA6" target="_blank" rel="noopener noreferrer">ម.ប.ស. វិទ្យាល័យ សុខអាន ព្រៃសណ្តែក នៅភូមិព្រៃសណ្តែក ឃុំព្រៃស្លឹក ស្រុកទ្រាំង ខេត្តតាកែវ</a>
                </li>
            </ul>
