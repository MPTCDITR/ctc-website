        ...
        <div class="p-4 rounded-lg">
            ...
            <ul class="list-disc list-inside">
                <li class="flex items-center gap-x-3">
                    ...
                    <a href="https://maps.app.goo.gl/cFmjvF3CLqhYi8hd8" target="_blank" rel="noopener noreferrer">ម.ប.ស. វិទ្យាល័យ ប៊ុនរ៉ានីហ៊ុនសែនភ្នំជីសូរ នៅភូមិដក់ពរ ឃុំរវៀង ស្រុកសំរោង ខេត្តតាកែវ</a>
                </li>
            </ul>
