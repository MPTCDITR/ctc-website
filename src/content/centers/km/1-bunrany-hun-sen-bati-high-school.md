        ...
        <div class="p-4 rounded-lg">
            ...
            <ul class="list-disc list-inside">
                <li class="flex items-center gap-x-3 ">
                    ...
                    <a href="https://maps.app.goo.gl/zbwRjk57eybqQhU79" target="_blank" rel="noopener noreferrer">ម.ប.ស. វិទ្យាល័យប៊ុនរ៉ានីហ៊ុនសែនបាទី នៅភូមិត្រពាំងលាន ឃុំចំបក់ ស្រុកបាទី ខេត្តតាកែវ</a>
                </li>
            </ul>
