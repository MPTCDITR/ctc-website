        ...
        <div class="p-4 rounded-lg">
            ...
            <ul class="list-disc list-inside">
                <li class="flex items-center gap-x-3">
                    ...
                    <a href="https://maps.app.goo.gl/XEAqRgCPKNFxJrRr6" target="_blank" rel="noopener noreferrer">ផ្ម.ប.ស. វិទ្យាល័យ សុខអាន ថ្នល់បំបែក នៅភូមិបន្ទាយ ឃុំជីខ្មា ស្រុកទ្រាំង ខេត្តតាកែវ</a>
                </li>
            </ul>
