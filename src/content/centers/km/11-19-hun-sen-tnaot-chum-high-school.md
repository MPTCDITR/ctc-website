        ...
        <div class="p-4 rounded-lg">
            ...
            <ul class="list-disc list-inside">
                <li class="flex items-center gap-x-3">
                    ...
                    <a href="https://maps.app.goo.gl/qS3rGunCHoTUDuqp9" target="_blank" rel="noopener noreferrer">ម.ប.ស. វិទ្យាល័យ ហ៊ុនសែនត្នោតជុំ នៅភូមិត្នោតជុំ ឃុំអូរសារាយ ស្រុកត្រាំកក់ ខេត្តតាកែវ</a>
                </li>
            </ul>
