        ...
        <div class="p-4 rounded-lg">
            ...
            <ul class="list-disc list-inside">
                <li class="flex items-center gap-x-3">
                    ...
                    <a href="https://maps.app.goo.gl/5yjCYWZ2hRVYMGGc8" target="_blank" rel="noopener noreferrer">ម.ប.ស. វិទ្យាល័យ ហ៊ុនសែនអង្គរបុរី នៅភូមិសាមគ្គី ឃុំអង្គរបូរី ស្រុកអង្គរបូរី ខេត្តតាកែវ</a>
                </li>
            </ul>
